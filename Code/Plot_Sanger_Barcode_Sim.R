...
# Change to country specific data 
# Compare RMSE to realised r
# Compare haplotype vs SNP approach
# Make slides for HapMap / Monday
###################################################################
rm(list = ls())
require(RColorBrewer)
display.brewer.all(colorblindFriendly = T)
palettes = c("Columbia" = 'YlOrRd', "Senegal" = 'YlGnBu', "FrenchGuiana" = 'YlGn')
...
for(Country in Countries){
  ...
  #+++++++++++++++++++++++++++++++++  
  load('../RData/Sanger_Amplicon_SimResults.Rdata')
  #+++++++++++++++++++++++++++++++++
...
for(Country in Countries){
  ...
  matplot(t(RMSEr_results), type = 'b', pch = 20, lty = 1, col = cols_ks, panel.fist = grid(), 
          ...
          xlab = expression('Relatedness,'~italic(r)), xaxt = 'n', bty = 'n')
  ...
  matplot(RMSEk_results, type = 'b', pch = 20, lty = 1, col = cols_rs, panel.fist = grid(),  
          ...
          xlab = expression('Switch rate parameter,'~italic(k)), xaxt = 'n', bty = 'n')
